...
val paragraphsPost1 = when (locale) {
    "en" -> paragraphsPost1_en// Inglês
    "pt" -> paragrafosPost1 // Português
    else -> paragraphsPost1_en // Idioma padrão
}
...
val urlPost1 = when (locale) {
    "en" -> "https://medium.com/androiddevelopers/gradle-path-configuration-dc523f0ed25c"// Inglês
    "pt" -> "https://medium.com/android-dev-br/modulariza%C3%A7%C3%A3o-android-parte-1-b69b509571c9" // Português
    else -> "https://medium.com/androiddevelopers/gradle-path-configuration-dc523f0ed25c" // Idioma padrão
}
...
val post1_pt = Post(
    id = "dc523f0ed25c",
    title = "Modularização Android Parte 1",
    subtitle = "MVVM, Koin, Rx, Room, Databinding e um pouco mais…",
    url = urlPost1,
    publication = publication,
    metadata = Metadata(
        author = pietro,
        date = "5 de Junho, 2019",
        readTimeMinutes = 1
    ),
    paragraphs = paragraphsPost1,
    imageId = R.drawable.post_1,
...
val post1 = when (locale) {
    "en" -> post1_en// Inglês
    "pt" -> post1_pt // Português
    else -> post1_en // Idioma padrão
}
val post2 = Post(
    id = "7446d8dfd7dc",
